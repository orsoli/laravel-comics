    ...
    <div class="row">
        <div class="col-8">
            <div class="card border border-0">
                ...
                <div class="card-body">
                    <a href="{{route("show", $movies[0]["id"])}}" class="text-dark text-decoration-none"><h5 class="card-title fs-1">{{$movies[0]["title"]}}</h5></a>
        ...
        <div class="col-4 d-flex flex-column gap-3">
            <div class="card">
                ...
                <div class="card-body">
                    <a href="{{route("show", $movies[1]["id"])}}"><h5 class="card-title">{{$movies[1]["title"]}}</h5></a>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <a href="{{route("show", $movies[2]["id"])}}"><h5 class="card-title">{{$movies[2]["title"]}}</h5></a>
